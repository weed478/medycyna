...
class Inka:
    ...
    def load_video_data():
        ...
        if not is_pickle:
            ...
            # frames_filtered = ...
            frames_filtered = [gaussian_filter(single_frame, sigma=3) for single_frame in frames]
    ...
    def anim_process_frame(self, i):
        ...
        # cv2.imshow('frame_diff_median', frame_diff_median)
        ...
        if i > 20:
            ...
            if roi_moments["m00"] != 0 and roi_moments["m00"] > 100 and roi_moments["m00"] < 10000:
                # print(roi_moments)
